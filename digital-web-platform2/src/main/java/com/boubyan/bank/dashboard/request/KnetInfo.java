/**
 * @Copyright reserved to Boubyan bank
 */
package com.boubyan.bank.dashboard.request;
 ...
 *
 */
public class KnetInfo implements Serializable {
	...
	public String toString() {
		return "KnetInfo [amt=" + amt + ", auth=" + auth + ", authRespCode=" + authRespCode + ", avr=" + avr
